...
func init() {
	...
	RootCmd.PersistentFlags().StringVarP(&constness, "type", "t", "random", "Set the value to 'constant' in order to fill the matrix with constant values (choice are random / constant)")
